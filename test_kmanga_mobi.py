...
from kmanga_mobi import Container, MangaMobi
from kmanga_mobi.mobi import WIDTH, HEIGHT
...
class TestContainer(unittest.TestCase):
    ...
    def setUp(self):
        shutil.copytree('fixtures/container01', 'fixtures/dummy')
        self.container = Container('fixtures/dummy')
    ...
    def test_create_new(self):
        container = Container('fixtures/empty')
        container.create()
        self.assertTrue(os.path.exists('fixtures/empty'))
        container.clean()
        self.assertFalse(os.path.exists('fixtures/empty'))

    def test_create(self):
        with self.assertRaises(ValueError):
            self.container.create(clean=False)
        self.assertTrue(os.path.exists('fixtures/dummy/cover.jpg'))
        self.container.create(clean=True)
        self.assertFalse(os.path.exists('fixtures/dummy/cover.jpg'))

    def test_add_image(self):
        self.container.add_image('fixtures/images/width-small.jpg')
        self.assertTrue(
            os.path.exists('fixtures/dummy/images/006.jpg'))

        self.container.add_image('fixtures/images/width-small.jpg',
                                 as_link=True)
        self.assertTrue(
            os.path.exists('fixtures/dummy/images/007.jpg'))

        self.container.add_image('fixtures/images/width-small.jpg',
                                 adjust=Container.ROTATE)
        self.assertTrue(
            os.path.exists('fixtures/dummy/images/008.jpg'))

        self.container.add_image(
            'fixtures/images/height-large-horizontal.jpg',
            adjust=Container.ROTATE)
        self.assertTrue(
            os.path.exists('fixtures/dummy/images/009_rotate.jpg'))

        self.container.add_image('fixtures/images/width-small-bw.png',
                                 adjust=Container.ROTATE)
        self.assertTrue(
            os.path.exists('fixtures/dummy/images/010.png'))

        self.container.add_image('fixtures/images/width-small.jpg',
                                 _filter=Container.FILTER_FOOTER)
        self.assertTrue(
            os.path.exists('fixtures/dummy/images/011.jpg'))

        self.container.add_image('fixtures/images/width-small.jpg',
                                 _filter=Container.FILTER_MARGIN)
        self.assertTrue(
            os.path.exists('fixtures/dummy/images/012.jpg'))
    ...
    @patch('kmanga_mobi.mobi.Container.get_image_info')
    @patch('kmanga_mobi.mobi.os.rename')
    def test_set_image_adjust(self, rename, get_image_info):
        ...
        self.container.set_image_adjust(0, Container.ROTATE)
        rename.assert_called_with('fixtures/dummy/some_path',
                                  'fixtures/dummy/some_path_rotate')

    def test_set_cover(self):
        os.unlink('fixtures/dummy/cover.jpg')
        self.container.set_cover('fixtures/images/width-small.jpg')
        self.assertTrue(
            os.path.exists('fixtures/dummy/cover.jpg'))
        ...
        os.unlink('fixtures/dummy/cover.jpg')
        self.container.set_cover('fixtures/images/width-small-bw.png',
                                 adjust=Container.ROTATE)
        self.assertTrue(
            os.path.exists('fixtures/dummy/cover.jpg'))
    ...
    def test_adjust_image(self):
        for name in ('width-small.jpg', 'width-large.jpg',
            ...
            img_path = 'fixtures/images/%s' % name
...
class TestMangaMobi(unittest.TestCase):
    ...
    def _test_create(self, has_cover):
        ...
        self.assertEqual(full_path, 'fixtures/dummy/title.mobi')
    ...
    def test_style_css(self):
        ...
        with open('fixtures/dummy/css/style.css') as f1:
            with open('fixtures/dummy/css/style.css.reference') as f2:
